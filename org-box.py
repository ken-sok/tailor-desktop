...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.CustomerNameBox.setFixedSize(120, 50)
        ...
        #self.PhoneBox.setFixedSize(120, 50)
        ...
        #self.AddressBox.setFixedSize(120, 50)
        self.AddressBox.setObjectName("AddressBox")

        #label texts - delete 
        self.CustomerInfoTitle.setText("ព័ត៌មានអតិថិជន")
        self.CustomerNameLabel.setText("ឈ្មោះ:")
        self.AddressLabel.setText("ឤស័យដ្ឋាន:")
        self.PhoneLabel.setText("លេខទូរស័ព្ទ:")
        '''
        END OF Customer BOX 
        '''
        ...
        self.RadioPicLabel.setText("yoyo")
        #self.RadioPicLabel.setStyleSheet("background-color: blue")
        ...
        CustomerBoxLayout.addWidget(self.NameBoxBackground, 0, 0)
        
        CustomerBoxLayout.addWidget(self.CustomerInfoTitle, 0, 0)
        ...
        MainLayout.addLayout(CustomerBoxLayout, 0, 0)
        MainLayout.setColumnStretch(0, 1)
        #staff box 

        StaffBoxLayout = QGridLayout()
        StaffBoxLayout.addWidget(self.StaffBoxBackground, 0, 0)
        ...
        #StaffBoxLayout.addWidget(self.DeadlineSelectedLabel, 2, 2)

        MainLayout.addLayout(StaffBoxLayout, 1, 0)
        #MainLayout.setColumnStretch(0, 1)

        #preferences box
        
        PreferencesBoxLayout = QGridLayout()
        PreferencesBoxLayout.addWidget(self.CustomerPrefBoxBackground, 0, 0)
        ...
        MainLayout.addLayout(PreferencesBoxLayout, 0, 1)
        

        #special req box
        
        SpecReqBoxLayout = QGridLayout()
        SpecReqBoxLayout.addWidget(self.SpecialReqBoxBackground, 0, 0,)

        SpecReqBoxLayout.addWidget(self.SpecialReqTitle, 0, 0)
        SpecReqBoxLayout.addWidget(self.SpecialReqBox, 1, 0)
        
        MainLayout.addLayout(SpecReqBoxLayout, 1, 1)
        #MainLayout.setColumnStretch(1, 1)

        #measurements boxes
        self.MeasurementGroupBoxes = QHBoxLayout()
        self.MeasurementGroupBoxes.addWidget(self.ShirtDressSkirtBox)
        self.MeasurementGroupBoxes.addWidget(self.PantGroupBox)

        MainLayout.addLayout(self.MeasurementGroupBoxes, 2, 0)
